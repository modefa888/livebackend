const includes = require('C:\\Users\\Administrator\\Desktop\\CODE\\livebot\\backend\\bots\\livebot\\src\\config\\includes');
const cheerio = require('cheerio');

const host = 'https://www.51cg1.com';


const getStationStatus = async (mid = 'wpcz') => {
    try {
